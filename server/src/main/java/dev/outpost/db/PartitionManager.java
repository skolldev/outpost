...
public class PartitionManager {
	...
	private static final List<String> TABLES = List.of(EVENT, LOG_RECORD);
	...
	/** Ensures the partition of {@code table} covering {@code timestamp} exists. Cheap when already known. */
